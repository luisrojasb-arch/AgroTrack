...
/**
 * @description Modal de confirmación para eliminar un registro de preñez.
 * @param {Object} props - Propiedades del modal.
 */

export default function DeletePrenezModal({
  isOpen,
  onClose,
  prenez,
  onConfirm,
    ...
    >
      <div className="flex flex-col items-center justify-center text-center px-6 pb-2">
        ...
        <p className="text-[14px] text-gray-500">
          Estás a punto de eliminar la preñez registrada de{" "}
          <span className="font-bold text-black">
            {prenez?.madre || prenez?.codigo}
          </span>
