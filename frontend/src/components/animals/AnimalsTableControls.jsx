...
export default function AnimalsTableControls({ activeTab }) {
  ...
  const defaultFilter = activeTab === "madre" ? "Todos" : "Todos los sexos";
  ...
  const opcionesSelect =
    activeTab === "madre"
      ? ["Todos", "En Evaluación", "Seleccionada", "Descartada"]
      : ["Todos los sexos", "Macho", "Hembra"];
  ...
  const showSelect = activeTab !== "lotes";
